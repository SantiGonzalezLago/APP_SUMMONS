...
interface FeyStats {
  ...
  feyBladeDamage: string;
}

@Component({
  selector: 'app-fey',
  templateUrl: 'fey.page.html',
  styleUrls: ['fey.page.scss'],
...
export class FeyPage implements OnInit {
  selectedLevel = 3;
  selectedType: string = 'Fuming';
  stats: FeyStats | null = null;
  currentHP = 0;
  maxHP = 0;
  isHPModalOpen = false;

  levels: number[] = [3, 4, 5, 6, 7, 8, 9];
  types: string[] = ['Fuming', 'Mirthful', 'Tricksy'];
  ...
  private updateStats(): void {
    ...
    this.stats = { ac, hp, multiattackCount, feyBladeDamage };
  }
